...
class Invoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
    ...
    protected function _drawHeader(\Zend_Pdf_Page $page)
    {
        ...
        $lines[0][] = ['text' => __('Weight netto'), 'feed' => 380, 'align' => 'right', 'font_size' => 7];

        $lines[0][] = ['text' => __('Weight bruto'), 'feed' => 445, 'align' => 'right', 'font_size' => 7];
...
------';
    ...
    private function insertIncoterms(\Zend_Pdf_Page $page)
    {
        $text = __('Incoterms: DAP');

        $page->setFillColor(new \Zend_Pdf_Color_GrayScale(1));
        $this->_setFontRegular($page, 10);
        $docHeader = $this->getDocHeaderCoordinates();
        $page->drawText($text, 500, $docHeader[1] - 15, 'UTF-8');
    }
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $createdDateTime = date('F j, Y', $date);
